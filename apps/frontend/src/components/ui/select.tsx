...
function SelectItem({ className, children, title, ...props }: SelectItemProps) {
  return (
    <SelectPrimitive.Item
      ...
      {...props}
    >
      <SelectPrimitive.ItemText className="flex flex-1 shrink-0 gap-2 overflow-hidden text-ellipsis whitespace-nowrap">
        {children}
